...
interface EditorProps {
    ...
    onPlannerPromptChange: (val: string) => void;
    onPainterPromptChange: (val: string) => void;
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2">
                    <Label>版本备注（可选）</Label>
                    <Input value={note} onChange={(e) => onNoteChange(e.target.value)} placeholder="例如：Hero 强化一致性 + 手账模板收敛" />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        onChange={(e) => onPlannerPromptChange(e.target.value)}
                ...
                <div className="space-y-2">
                    ...
                    <Textarea
                        ...
                        onChange={(e) => onPainterPromptChange(e.target.value)}
                        className="min-h-[220px] font-mono text-xs"
                    />
                </div>
