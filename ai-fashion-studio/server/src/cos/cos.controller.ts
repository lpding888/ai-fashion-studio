...
export class CosController {
    ...
    async getCredentials(
        ...
        try {
            ...
            this.logger.log(`Check Keys: SecretId=${process.env.TENCENT_SECRET_ID ? 'YES' : 'NO'}, SecretKey=${process.env.TENCENT_SECRET_KEY ? 'YES' : 'NO'}, Bucket=${process.env.COS_BUCKET}`);
